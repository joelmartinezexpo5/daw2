...
class BD {
    #vehiculos = []; // Inicialización de la propiedad privada
    #reparaciones = []; // Inicialización de la propiedad privada
    #siguienteVehiculoId;
    #siguienteReparacionId;

    constructor() {
        this.#siguienteVehiculoId = 1; // Inicializa el contador de IDs
        this.#siguienteReparacionId = 1; // Inicializa el contador de IDs
        this.#cargarDatos(); // Cargar los datos al construir la clase
    }
    ...
    #cargarDatos() {
        datos.vehiculos.forEach(vehiculoData => {
            ...
            this.#vehiculos.push(vehiculo); // Usa correctamente la propiedad privada
        });
        ...
        datos.reparaciones.forEach(reparacionData => {
            ...
            this.#reparaciones.push(reparacion); // Usa correctamente la propiedad privada
        });

        // Actualiza los siguientes IDs según los datos cargados
